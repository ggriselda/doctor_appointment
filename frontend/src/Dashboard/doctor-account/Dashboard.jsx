              ...
              {data.isApproved === "pending" && (
                <div className="flex p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1
                      1 0 00-1-1H9z"
                      clipRule="evenodd"
                    ></path>
                  </svg>
                  ...
                  <div className="ml-3 text-sm font-medium">
                    Vui lòng cập nhật dữ liệu của bạn. Chúng tôi sẽ xác nhận thông tin trong vòng 3 ngày
                  </div>
                </div>
              )}
              <div className="mt-8">
